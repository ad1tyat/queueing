...
myfile = open("out_KOUQ_0_5_buf_2_k_8.txt", "rt")
contents = myfile.readlines()
myfile.close()               


myfile3 = open("out_KOUQ_0_5_buf_3_k_8.txt", "rt")
contents3 = myfile3.readlines()
myfile3.close()               


myfile4 = open("out_KOUQ_0_5_buf_4_k_8.txt", "rt")
...
plt.title("KOUQ, K=0.8N, p = 0.5, T = 10000", fontsize=15)
