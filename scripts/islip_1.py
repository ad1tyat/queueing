...
myfile = open("out_ISLIP_1_buf_2.txt", "rt")
contents = myfile.readlines()
myfile.close()               


myfile3 = open("out_ISLIP_1_buf_3.txt", "rt")
contents3 = myfile3.readlines()
myfile3.close()               


myfile4 = open("out_ISLIP_1_buf_4.txt", "rt")
...
for line in contents3:
    arr = line.split('\t')
    vals3.append(float(arr[-2]))
for line in contents4:
    arr = line.split('\t')    
    vals4.append(float(arr[-2]))
...
plt.title("ISLIP, p = 1, T = 10000", fontsize=15)
